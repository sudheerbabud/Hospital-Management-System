...
<body>
    <div class="box">
        ...
        <p>The patient record has been successfully removed.</p>
        <!-- Button to add another patient -->
        <a href="index.jsp">
            <button class="btn btn-primary">Add Another Patient</button>
        </a>
        <!-- Form to view all patient details -->
        <form action="viewPatient" method="post" style="margin-top: 20px;">
            <h4>Want to see all the patient details?</h4>
            <button type="submit" class="btn btn-success">View Patient List</button>
        </form>
    </div>
</body>
</html>
